...
template <class T>
set<T> SetMethods::SetIntersection(const set<T> &A,
                              const set<T> &B)
{
    set<T> out;
...
template <class T>
set<T> SetMethods::SetUnion(const set<T> &A, const set<T> &B)
{
    set<T> out;
...
template <class T>
bool SetMethods::SetFind(const set<T> &haystack,
                    const T &needle)
{
...
template <class T>
set<T> SetMethods::SetDifference(set<T> pos, set<T> neg)
{
    set<T> out;

#ifndef DYNET_NODES_OOC_SELECT_H_
#define DYNET_NODES_OOC_SELECT_H_
...
namespace dynet {
    struct SelectNode: public Node {
        explicit SelectNode (const std::initializer_list<VariableIndex>& a, LookupParameter p): dim(p.get_storage().dim), Node(a), params(p){}
